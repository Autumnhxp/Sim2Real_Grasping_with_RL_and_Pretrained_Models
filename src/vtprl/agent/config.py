class Config:
    ...
    def get_config_dict():
        config_dict = {
            ...
            ##should not change, For using inverse kinematic methode, "with dart" should be used 
            ...
            'num_joints': 7,
            ##should not change, All 7 should be used, except for simple test 

            # whether to use images as  state representation, an example code is in iiwa_joint_vel env
            'use_images': True,
            ##change: False to true: image based policy
            ##should also be changed in .xml
